...
<html>
  ...
  <body>
        ...
        <!--导航条按钮添加 -->
          <div style="padding:10px 0px 0px 0px" style="width:100%;margin:0 0">
            <div class="form-group col-xs-4">
               <a href="<?php echo U('/Home/Index/shopcontent',array('book_id'=>$book_id));?>" type="button" class="glyphicon glyphicon-chevron-left" style="padding:5px;color:white"></a>
            </div>
   ...
   <!--商品详情图片-->
     <input type="hidden" id="bookid" value="<?php echo U('/Home/Index/shopcontent',array('book_id'=>$book_id));?>">
    <div id="box" style="overflow-x:hidden;">
      <div style="padding:80px 0px 0px 0px ;text-align: center; ">
       <!--textarea 设置ID传值-->
        <textarea rows="8" cols="40" style=" resize:none;" id="message">
