...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      .wrapper {  display:inline-block; background-image: url("/jewelry/Public/images/upload.jpg"); height:50px; width:50px; overflow:hidden; cursor:pointer;float: left;}
 ...
 <script type="text/javascript">
    function del(goods_id){
      var url="<?php echo U('Index/insalegoods');?>";
      $.post(url,{goods_id:goods_id},
        function(data){
          if(data=="0"){
           alert("你的网络有问题！");
          }else{
  ...
  <div class="container" style="width:80%;height:25%;">        
   ...
   <!--个人图像-->
      <div class="row border_btm" style="padding:15px 0px 0px 0px;border:1px solid #ABABAB;">
        ...
        <!--用户头像-->
           <a href="#" >
            <img src="/jewelry/Public/images/tx.jpg" class="img-circle" width="80px" height="80px">
          </a> 
        </div>
      ...
      <!--跳跳框-->
          ...
          <div class="col-md-12 column">
            <div class="tabbable" id="tabs-373361">
              <ul class="nav nav-tabs">
                <li class="active">
                   <a href="#panel-502288" data-toggle="tab">我的首饰</a>
                </li>
               <!--  <li >
              ...
              <div class="tab-content">
                ...
                <!--手风琴组合-->
                  ...
                  <div id="collapseOne" class="panel-collapse collapse in">
                    <?php if(is_array($nowgoods)): foreach($nowgoods as $key=>$vo): ?><div style class="panel-body">      
                        </div>
                        <!--在售列表-->
                          <div class="row" style="font-size:16px;line-height:28px;">
                            <div class="col-xs-2 " style="text-align:center">
                              <a href="#" >
                                  <img src="/jewelry/Public/uploads/<?php echo ($vo["goods_url"]); ?>"
                                       alt="通用的占位符缩略图" width="80px" height="80px"> 
                              </a>
                            </div>
                            <div class="col-xs-10" style="float:left">
                               <span >
                                   <?php echo ($vo["goods_content"]); ?>
                                </span>
                                <div style="color:#ED6F00;font-size:16px">
                                   订单价格：
                                   <a style="font-color: #EA0000"><?php echo ($vo["order_allprice"]); ?></a>
                                </div>
                                <div  style="font-size:14px">
                                  <span>交易状态：</span>
                                  <span style="color:#ED6F00;">等待配送</span>
                                </div>
                            </div>              
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                          <!--列表-->
                          <?php if(is_array($ordering)): foreach($ordering as $key=>$vo): ?><div class="row" style="font-size:16px;line-height:28px;border-bottom:1px solid #C3C5C9;">
                            <div class="col-xs-2 " style="text-align:center">
                              <a href="#" >
                                  <img src="/jewelry/Public/uploads/<?php echo ($vo["goods_url"]); ?>"
                            ...
                            <div class="col-xs-10" style="float:left">
                               <span >
                                ...
                                <div  style="font-size:14px">
                                  <span>交易状态：</span>
                                  <span style="color:#ED6F00;">配送中</span>
                                </div>
                            </div>       
                          </div><!--列表--><?php endforeach; endif; ?>
                        </div>
                      </div>
                    </div>
                    <div class="panel panel-default">
                      ...
                      <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                          <!--列表-->
                          <?php if(is_array($ordered)): foreach($ordered as $key=>$vo): ?><div class="row" style="font-size:16px;line-height:28px;border-bottom:1px solid #C3C5C9;">
                            <div class="col-xs-2 " style="text-align:center">
                              <a href="#" >
                                  <img src="/jewelry/Public/uploads/goods_url"
                                       alt="通用的占位符缩略图" width="100px" height="80px"> 
                              </a>
                            </div>
                             <div class="col-xs-10" style="float:left">
                ...
                <div class="tab-pane " id="panel-465421">
                 <!--  <div  class="row" style="border-bottom:1px solid #ABABAB;margin-right:-4px;margin-top: 10px;">
                  <div class="col-xs-2" style="  border-right:1px solid #666;">
                    <a href="#" >
                      <img src="/jewelry/Public/images/3.jpg" width="80px" height="50px">
                    </a>
                  </div>
        ...
        <div class="col-xs-9" >
          <input type="text" class="form-control" id="goodsname" name="goodsname" placeholder="请输入" size="16">
          </div>
        </div>
        ...
        <div class="col-xs-9" >
          <input type="text" class="form-control" id="goodsnumber" name="goodsnumber" placeholder="请输入" size="16">
          </div>
        </div>
      <div class="col-xs-6" >
      ...
      <div class="col-xs-6" style="text-align:right">
        <input type="checkbox" name="isname" id="isname" value="1"> 是否匿名 
                          ...
                          <!--跳转-->
                            <a onclick="sub2();" type="button" class="btn btn-default" style="color:white;background:#34352C;width:80%;height:100%;">发布首饰</a>
                          </div>
                        </form>
                    </div>
                </div>
